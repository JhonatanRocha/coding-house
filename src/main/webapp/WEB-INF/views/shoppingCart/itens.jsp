...
<tags:pageTemplate title="Your Shopping Cart">
	
	<jsp:attribute name="extraScripts">
        <script>console.log("We're excited to tell you that we received your order of ${shoppingCart.quantity} itens with the total price of R$${shoppingCart.total}");</script>
    </jsp:attribute>
		...
		<section class="container middle">
			  <h2 id="cart-title">Your Shopping Cart</h2>
			    ...
			    <table id="cart-table">
			      ...
			      <tbody>
				      <c:forEach items="${shoppingCart.itens}" var="item">
					      <tr>
					          ...
					          <td class="remove-item">
					          	<form:form servletRelativeAction="${s:mvcUrl('SCC#remove').arg(0, item.product.id).arg(1, item.priceType).build()}" method="post">
			      ...
			      <tfoot>
			        <tr>
			          <td colspan="4">
			          	<form:form servletRelativeAction="${s:mvcUrl('PC#checkout').build()}" method="post">
		  ...
		  <h2><a href="${s:mvcUrl('HC#index').build()}">Take a look on our published books!</a></h2>
		</section>		
	</jsp:body>
</tags:pageTemplate>